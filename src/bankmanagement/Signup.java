...
// color class and image icon comes from AWT package
...
public class Signup extends JFrame implements ActionListener {
   ...
   Signup() {
//       the no generated is of 4 digit
      ...
      JLabel imagei3 = new JLabel(i3);
      imagei3.setBounds(20, 0, 100, 100);
      this.add(imagei3);
